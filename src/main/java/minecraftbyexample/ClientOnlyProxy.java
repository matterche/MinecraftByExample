...
/**
 * ClientProxy is used to set up the mod and start it running on normal minecraft. It contains all the code that should
 * run on the client side only. For more background information see here
...
public class ClientOnlyProxy extends CommonProxy {
    ...
    public void preInit() {
        ...
        minecraftbyexample.jahd01_block_hello.StartupClientOnly.preInitClientOnly();
    ...
    public void init() {
        ...
        minecraftbyexample.jahd01_block_hello.StartupClientOnly.initClientOnly();
    ...
    public void postInit() {
        ...
        minecraftbyexample.jahd01_block_hello.StartupClientOnly.postInitClientOnly();
    ...
    @Override
    public boolean playerIsInCreativeMode(final EntityPlayer player) {
