...
public class StartupClientOnly {
    ...
    public static void initClientOnly() {
        ...
        // This is currently necessary in order to make your block render properly when it is an item (i.e. in the
        // inventory
        // or in your hand or thrown on the ground).
        // Minecraft knows to look for the item model based on the GameRegistry.registerBlock.  However the
        // registration of
        ...
        Item itemBlockHello = GameRegistry.findItem("minecraftbyexample", "jahd01_block_hello");
        ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation(
                "minecraftbyexample:jahd01_block_hello", "inventory");
        final int DEFAULT_ITEM_SUBTYPE = 0;
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(itemBlockHello, DEFAULT_ITEM_SUBTYPE,
